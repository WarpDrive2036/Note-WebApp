                    ...
                    <div class="relative ml-3">
                        <div>
                            <button type="button" class="flex max-w-xs items-center rounded-full bg-gray-800 text-sm focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800" id="user-menu-button" aria-expanded="false" aria-haspopup="true">
                                ...
                                <!-- When a user session is initialized show their photo otherwise give them the option to register -->
                                <?php if(isset($_SESSION['user'])) :?>
                        ...
                        <?php if (isset($_SESSION['user'])) :?>
                        <!-- Idempotence: multiple, identical requests will behave the same ex:"GET".-->
                            <div class="ml-8">
                            <!-- we won't be using < a href (returns GET) for Idempotence reasons as deleting a
                             session isn't SAFE Idempotence wise so a POST request will do the job-->
